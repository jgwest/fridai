...
/** JSON representation of PirateCardInfo */
public class JsonPirateCardInfo {

	private int hazardPoints;

	private int freeFightingCards;

	public int getHazardPoints() {
		return hazardPoints;
	}

	public void setHazardPoints(int hazardPoints) {
	...
	public void setFreeFightingCards(int freeFightingCards) {
