...
/** JSON representation of the (non-Pirate) game state, for serialization/deserialization by Jackson. */
public class JsonGameState implements IJsonSharedGameState {
	...
	private int[] hazardCards;

	private int[] discardHazards;
	...
	// Nullable
	private Integer activeHazardCard;
	...
	public int[] getHazardCards() {
		return hazardCards;
	}

	public void setHazardCards(int[] hazardCards) {
		this.hazardCards = hazardCards;
	}

	public int[] getDiscardHazards() {
		return discardHazards;
	}

	public void setDiscardHazards(int[] discardHazards) {
	...
	public Integer getActiveHazardCard() {
		return activeHazardCard;
	}

	public void setActiveHazardCard(Integer activeHazardCard) {
